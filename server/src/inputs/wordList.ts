export const DEFAULT_WORD_LIST = [
    ...
    'BEING', 'BENCH', 'BILLY', 'BIRTH', 'BLACK', 'BLAME', 'BLANK', 'BLIND', 'BLOCK', 'BLOOD',
    ...
    'PARTY', 'PEACE', 'PETER', 'PHASE', 'PHONE', 'PHOTO', 'PIANO', 'PICKS', 'PIECE', 'PILOT',
    ...
    'TEAMS', 'TEENS', 'TEETH', 'TELLS', 'TERMS', 'TESTS', 'THANK', 'THEFT', 'THEIR', 'THEME',
    ...
    'TRUCK', 'TRULY', 'TRUNK', 'TRUST', 'TRUTH', 'TWICE', 'TWIST', 'TYLER', 'TYPES', 'UNCLE',
